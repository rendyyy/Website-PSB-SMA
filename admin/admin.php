...
<?php 
    ...
    if(isset($_POST['adminbaru'])){
        ...
        $insert = mysqli_query($conn,"insert into admin(adminnama,adminemail,adminpassword) values('$nama','$email','$password')");
        if($insert){
            //berhasil bikin
...
<head>
    ...
    <title>Kelola Admin - SMAN 3 Tambun Selatan</title>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
                                ...
                                <div class="form-group">
									<label>Nama</label>
									<input name="adminnama" type="nama" class="form-control" placeholder="Nama Lengkap">
								</div>
