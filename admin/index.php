...
<?php 
    ...
    $jml_pendaftar = mysqli_query($conn, "SELECT * FROM user,userdata where user.userid = userdata.userid");

    if(!$jml_pendaftar){
        die('Query Error : '.mysqli_error($conn));
    }

    $jml_lolos = mysqli_query($conn, "SELECT * FROM user,userdata where user.userid = userdata.userid AND userdata.status = 'Lolos'");
...
<head>
    ...
    <title>Dashboard Admin - SMAN 3 Tambun Selatan</title>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="h3 font-weight-bold text-info mb-2 mt-5">SISWA TERDAFTAR</div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h3 font-weight-bold text-success mb-2 mt-5">LOLOS SELEKSI</div>
                                            <div class="h3 font-weight-bold  mb-2">
