...
<h2>DATA PRIBADI</h2>
<br>
<img src="../user/images/foto/'. $ambil['foto'].'" width="120px">
...
<h2>SERTIFIKAT</h2>
<img src="../user/images/sertifikat/'.$ambil['sertifikat'].'" width="350px;" alt= "Tidak Ada Sertifikat">
<hr>

<h2>KARTU KELUARGA</h2>
<img src="../user/images/kartukeluarga/'.$ambilberkas['kartukeluarga'].'"style= width:350px;" alt= "Tidak Ada Kartu Keluarga">
<hr>

<h2>AKTA KELAHIRAN</h2>
<img src="../user/images/aktakelahiran/'.$ambilberkas['aktakelahiran'].'"style= width:350px;" alt= "Tidak Ada Akta Kelahiran">
<hr>

<h2>IJAZAH</h2>
<img src="../user/images/ijazah/'.$ambilberkas['ijazah'].'"style= width:350px;" alt= "Tidak Ada ijazah">
