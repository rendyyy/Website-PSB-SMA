                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive" style="overflow-x:hidden;">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                        ...
                                                        <br><?php echo "<img src='images/kartukeluarga/".$ambil['kartukeluarga']."'style= width:400px;'>"?>
                                                    </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                        <label for="akta" class=" form-control-label">Akta Kelahiran</label>
                                                        <br><?php echo "<img src='images/aktakelahiran/".$ambil['aktakelahiran']."'style= width:400px;'>"?>
                                                    </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                        <label for="ijazah" class=" form-control-label">Ijazah / Surat Keterangan Lulus</label>
                                                        <br><?php echo "<img src='images/ijazah/".$ambil['ijazah']."'style= width:400px;'>"?>
                                                    </div>
                                                </div>
                                        </div>
